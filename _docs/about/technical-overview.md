...
* `assets`: a folder of Javascript, font files and images that your whole project might use.
  ...
  * `js`: Javascript used in the template. Advanced users might add their own scripts here and manage which scripts are included on pages in `main.js`. See the ['Using Javascript'](../advanced/javascript.html) section for more detail.
